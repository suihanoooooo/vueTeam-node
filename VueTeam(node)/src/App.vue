...
export default {
  mounted () {
    var _this=this;
    this.$http.get('/loadNeibu').then(function(data){
    var arr=data.body;
    _this.$store.commit('LOADOBJ',arr);
    });

    this.$http.get('/loadShanghu').then(function(data){
    var arr=data.body;
    _this.$store.commit('LOADOBJ',arr);
    });

    this.$http.get('/loadQudao').then(function(data){
    var arr=data.body;
    _this.$store.commit('LOADOBJ',arr);
    });
  },
